...
!function () {
    ...
    var dialog_rewards = document.querySelector('.dialog-rewards');
    //提示框按钮
    var close_btn = document.querySelector('.close-btn');
    close_btn.onclick = function () {
        dialog_rewards.style.display = 'none';
    };
//    提现按钮
    var ipt_btn = document.querySelector('.ipt-btn');
    ipt_btn.onclick = function () {
        dialog_rewards.style.display = 'block';
    };
}();