...
function setClick() {
    var chooseBox_top = document.querySelector('.chooseBox_top');
    var nodeList = chooseBox_top.querySelectorAll('em');

    for (var i = 0; i < nodeList.length; i++) {
        nodeList[i].onclick = setSex;
        nodeList[i].idx = i;
    }
    function setSex() {
        for (var i = 0; i < nodeList.length; i++) {
        ...
        nodeList[this.idx].className = 'sel_sex';
